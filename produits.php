            ...
            <div class="main_content sidebar_on col-md-9 col-lg-9 left-sidebar">
                <div id="shopify-section-template-collection" class="shopify-section section_template section_template__collection">
                    ...
                    <div class="product_options">
                        ...
                        <?php 
                            $req = $bdd->query("SELECT COUNT(*) as total FROM products"); 
                            $result= $req->fetch();
                                ...
                                <?php foreach ($priceProducts as $priceProduct) : 
                                    $unit = $priceProduct['unit'];
                                                        ...
                                                        if($product_id == $id && !empty($unit)) {
                                                            ...
                                                            echo "<a href='produits.php/id={$price_id}' class='link-product-unit' id='{$price_id}' data-link='{$price}' data-tax='{$tax}'>" . $unit . '</a>';
